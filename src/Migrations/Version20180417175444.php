 ...
 */
class Version20180417175444 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user_details ADD user_id_id INT DEFAULT NULL, DROP user_id');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user_details ADD user_id INT NOT NULL, DROP user_id_id');
    }
}
